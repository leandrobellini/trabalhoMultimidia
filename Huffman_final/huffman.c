...
void huffmanDescomprime(char *, char *,int numeroAmostras);
...
/*
        ...
        */
        ...
        printf("Tamanho tabela compactacao: %d\n", validos);
...
void huffmanDescomprime(char *nomeOrigem, char *nomeDestino, int numeroAmostras){
